...
setup(
    ...
    description='Python Interface to bnlearn and other PGM libraries',  # Required
    ...
    url='https://github.com/cs224/pybnl',  # Optional
    ...
    #
    packages=find_packages(exclude=['contrib', 'docs', 'tests', 'examples', 'environment']),  # Required
    ...
    project_urls={  # Optional
        'Bug Reports': 'https://github.com/cs224/pybnl/issues',
        'Source': 'https://github.com/cs224/pybnl',
    },
